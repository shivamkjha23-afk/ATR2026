...
import { UNIT_OPTIONS, EQUIPMENT_TYPES, INSPECTION_STATUS_OPTIONS, FINAL_STATUS_OPTIONS } from './constants.js';
...
async function init() {
  ...
  fillSelect('unit_name', UNIT_OPTIONS);
  fillSelect('equipment_type', EQUIPMENT_TYPES);
  fillSelect('status', INSPECTION_STATUS_OPTIONS);
  fillSelect('final_status', FINAL_STATUS_OPTIONS);
